...
const STDLIB_MODULES: StdlibModule[] = [
  ...
  { path: '(std stm)', description: 'Software transactional memory with Clojure-style refs, dosync, alter', keywords: ['stm', 'transaction', 'atomic', 'tvar', 'concurrent', 'shared', 'lock-free', 'ref', 'dosync', 'alter', 'commute'], keyExports: ['make-tvar', 'atomically', 'tvar-read', 'tvar-write!', 'retry', 'or-else', 'make-ref', 'ref?', 'ref-deref', 'dosync', 'alter', 'ref-set', 'commute', 'ensure'] },
  ...
  { path: '(std iter)', description: 'Iteration forms with :when, :while, :let clause extensions', keywords: ['iterator', 'iterate', 'lazy', 'stream', 'range', 'sequence', 'generator', 'comprehension', 'when', 'while', 'let', 'clause'], keyExports: ['for', 'for/collect', 'for/fold', 'for/or', 'for/and', 'in-list', 'in-range', 'in-hash-pairs', 'in-lines'] },
  ...
  { path: '(std lazy-seq)', description: 'Clojure-style lazy sequences with memoized thunks', keywords: ['lazy', 'sequence', 'infinite', 'stream', 'cycle', 'repeat', 'iterate', 'memoize', 'clojure'], keyExports: ['lazy-seq', 'lazy-cons', 'lz-first', 'lz-rest', 'lz-seq', 'lz-empty?', 'lz-map', 'lz-filter', 'lz-take', 'lz-drop', 'lz-range', 'lz-repeat', 'lz-cycle', 'lz-iterate', 'lz-concat', 'lz->list'] },
  { path: '(std zipper)', description: 'Huet-style functional zippers for tree navigation and editing', keywords: ['zipper', 'tree', 'navigate', 'edit', 'functional', 'cursor', 'huet', 'ast'], keyExports: ['list-zip', 'vector-zip', 'zip-node', 'zip-down', 'zip-up', 'zip-left', 'zip-right', 'zip-replace', 'zip-edit', 'zip-root', 'zip-end?', 'zip-next', 'zip-prev'] },
  { path: '(std test check)', description: 'Property-based testing with generators and shrinking', keywords: ['property', 'test', 'generative', 'quickcheck', 'shrink', 'random', 'generator', 'check'], keyExports: ['gen:integer', 'gen:boolean', 'gen:string', 'gen:list', 'gen:one-of', 'gen:such-that', 'gen:fmap', 'gen:bind', 'for-all', 'check-property', 'quick-check'] },
  { path: '(std text edn)', description: 'EDN reader and writer with tagged literals', keywords: ['edn', 'data', 'serialize', 'clojure', 'tagged', 'literal', 'notation', 'read', 'write'], keyExports: ['read-edn', 'read-edn-string', 'write-edn', 'write-edn-string', 'edn-tag', 'edn-register-tag!'] },
  { path: '(std specter)', description: 'Specter-style composable path navigation for nested data', keywords: ['specter', 'path', 'navigate', 'transform', 'nested', 'lens', 'select', 'update', 'setval'], keyExports: ['sp-select', 'sp-transform', 'sp-setval', 'ALL', 'FIRST', 'LAST', 'MAP-KEYS', 'MAP-VALS', 'sp-filterer', 'sp-pred', 'sp-keypath', 'sp-comp'] },
  { path: '(std component)', description: 'Stuart Sierra-style component lifecycle with dependency ordering', keywords: ['component', 'lifecycle', 'system', 'dependency', 'start', 'stop', 'service', 'server', 'sierra'], keyExports: ['component', 'system-map', 'system-using', 'start', 'stop', 'register-lifecycle!', 'component-started?', 'system-started?'] },
  { path: '(std clojure)', description: 'Clojure-style persistent data structures: maps, sets, vectors, atoms, delay, future, promise', keywords: ['clojure', 'persistent', 'immutable', 'hash-map', 'hash-set', 'vector', 'atom', 'deref', 'swap', 'delay', 'future', 'promise'], keyExports: ['hash-map', 'hash-set', 'persistent-vector', 'assoc', 'dissoc', 'conj', 'get', 'contains?', 'merge', 'deref', 'swap!', 'delay', 'future', 'promise', 'deliver', 'realized?', 'set-select', 'set-project', 'set-join', 'map-invert'] },
];
